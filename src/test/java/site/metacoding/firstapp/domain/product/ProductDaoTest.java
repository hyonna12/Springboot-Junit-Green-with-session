...
public class ProductDaoTest {
  ...
  public void findAll_test() {
    ...
    // when
    List<Product> producListPS = productDao.findAll();

    // then
    assertEquals(2, producListPS.size());
  }
  ...
  public void update_test() {
    ...
    // when
    // product [id=1, productName="수박", productPrice=1000, productQty=100] 외부에서 받은
    // given 데이터
    // id=1을 where절에 걸어서 수정하려고
